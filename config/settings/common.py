...
ALLOWED_HOSTS = ['*']
CORS_ALLOWED_ORIGINS = ["http://195.214.235.46", "http://localhost", "http://127.0.0.1", "https://195.214.235.46"]
CSRF_TRUSTED_ORIGINS = ["http://195.214.235.46", "http://localhost", "http://127.0.0.1", "https://195.214.235.46"]
