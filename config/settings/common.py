...
CSRF_TRUSTED_ORIGINS = ["https://195.214.235.46", "http://localhost", "http://127.0.0.1", "http://localhost:5173"]
...
# SMS CONFIGURATION
KAVENEGAR_API_KEY = get_env("KAVENEGAR_API_KEY", default="7572365451704156594870726D765276525A7468646D553857503161754D683669545A6D755748517658383D")
KAVENEGAR_TEMPLATE = get_env("KAVENEGAR_TEMPLATE", default="otp-verify")
